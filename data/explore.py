...
from data_vis import candlestick, candlestick_format, hourly_patterns, daily_patterns, monthly_patterns, clean_data
import pandas as pd
...
if __name__ == "__main__":
    ...
    for y in [2007,2008,2009]:
        ...
        ohlc.append(candlestick_format(df, 'weekly'))
